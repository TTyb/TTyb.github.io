...
<p style="text-align:center"><img  src="/img/crawler6/result1.jpg"/></p>

安装完毕后，打开 `firefox` 浏览器，进入百度搜索，然后按下 `F12` ：

<p style="text-align:center"><img  src="/img/crawler6/result2.jpg"/></p>

点击 `网络` -> `JavaScrip` ，在输入关键词之前清除 **历史记录** 和 **清空请求列表**，然后在百度搜索栏中输入关键字 `TTyb|个人网站` ，那么网络下面会出现如下情况：

<p style="text-align:center"><img  src="/img/crawler6/result3.jpg"/></p>

点击 `url` 前面的 `+` 号，点击到 **参数** 的位置，可以看到当输入关键词的时候，百度向后台请求了这些数据：

<p style="text-align:center"><img  src="/img/crawler6/result4.jpg"/></p>
...
<p style="text-align:center"><img  src="/img/crawler6/result6.jpg"/></p>
