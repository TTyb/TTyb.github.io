...
<p style="text-align:center"><img  src="/img/crawler8/result1.jpg" class="img-responsive center-block"/></p>

`selenium` 可以根据页面前端的 `id` 、 `class` 、 `tag name` 等方式定位。打开百度首页， `F12` 选择 **点击查看页面中的元素** ，将指针放到搜索栏，点击左键：

<p style="text-align:center"><img  src="/img/crawler8/result2.jpg" class="img-responsive center-block"/></p>
