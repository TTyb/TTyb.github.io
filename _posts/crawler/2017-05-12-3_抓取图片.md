...
<p style="text-align:center"><img  src="/img/crawler3/result1.jpg" class="img-responsive"/></p>

这样可以看到红色箭头指向的图片的 `url` 为 `http://www.tybai.com/static/jpg/1.jpg`

在浏览器地址栏里面输入这个网址：

<p style="text-align:center"><img  src="/img/crawler3/result2.jpg" class="img-responsive"/></p>
...
<p style="text-align:center"><img  src="/img/crawler3/result3.jpg" class="img-responsive"/></p>
...
<p style="text-align:center"><img  src="/img/crawler3/result5.png" class="img-responsive"/></p>
...
<p style="text-align:center"><img  src="/img/crawler3/result4.jpg" class="img-responsive"/></p>
