...
<p style="text-align:center"><img src="/static/postimage/machinelearning/knn/996148-20170105145136300-1765225792.jpg" class="img-responsive"/></p>

上图中红色代表一个分簇，绿色代表另一个分簇，这两个簇现在可以称呼为 `训练样本` ，现在突然出现了一个 **黄色的四边形** ，如下：

<p style="text-align:center"><img src="/static/postimage/machinelearning/knn/996148-20170105150332472-737404780.jpg" class="img-responsive"/></p>
